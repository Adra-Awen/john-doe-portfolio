...
function Footer() {
  return (
    <footer className="container-fluid text-center">
      <div className="row" id="footer-infos">
          ...
          <div className="InfosContact-component">
            <InfosContact
              ...
              <div className="icons-social-media">
                <a href="https://github.com/github-johndoe" target="_blank" rel="nofollow noreferrer" aria-label="GitHub">
                ...
                <a href="https://x.com" target="_blank" rel="nofollow noreferrer" aria-label="X">
                ...
                <a href="https://linkedin.com" target="_blank" rel="nofollow noreferrer" aria-label="LinkedIn">
        ...
        <div className="col col-lg-4 col-12" id="footer-link-pages">
        ...
        <div className="col col-lg-4 col-12" id="footer-last-projects">
